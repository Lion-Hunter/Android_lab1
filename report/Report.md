...
Атрибут layout_weight присваивает представлению значение «важности» с точки зрения того, сколько места оно должно занимать в свободной области экрана. Большее значение веса определяет больший приоритет при распределении пространства между элементами макета. Вес по умолчанию равен нулю.
